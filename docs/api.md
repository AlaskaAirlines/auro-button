...
| `loadingText` | `loadingText` | `string`                                         |           | (Deprecated) Sets custom loading text for the `aria-label` on a button in loading state. If not set, the default value of "Loading..." will be used. |
