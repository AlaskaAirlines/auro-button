...
| buttonHref     | buttonHref   |           | string                                                      | `undefined` | When set, renders the button as an anchor (`<a>`) pointing to this URL. This exposes the `link` CSS part in place of `button`.                                                                                                                                                  |
...
| buttonTarget   | buttonTarget |           | string                                                      | `undefined` | Sets the `target` of the generated link (e.g. `_blank`, `_self`). Only applies when `buttonHref` is set.                                                                                                                                                                        |
