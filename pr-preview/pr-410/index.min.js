 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const a$1=Symbol.for(""),o$4=t=>{if(t?.r===a$1)return t?._$litStatic$},s$2=t=>({_$litStatic$:t,r:a$1}),i$5=(t,...r)=>({_$litStatic$:r.reduce(((r,e,a)=>r+(t=>{if(void 0!==t._$litStatic$)return t._$litStatic$;throw Error(`Value passed to 'literal' function must be a 'literal' result: ${t}. Use 'unsafeStatic' to pass non-literal values, but\n            take care to ensure page security.`)})(e)+t[a+1]),t[0]),r:a$1}),l$2=new Map,n$3=t=>(r,...e)=>{const a=e.length;let s,i;const n=[],u=[];let c,$=0,f=false;for(;$<a;){for(c=r[$];$<a&&void 0!==(i=e[$],s=o$4(i));)c+=s+r[++$],f=true;$!==a&&u.push(i),n.push(c),$++;}if($===a&&n.push(r[a]),f){const t=n.join("$$lit$$");void 0===(r=l$2.get(t))&&(n.raw=n,l$2.set(t,r=n)),e=u;}return t(r,...e)},u$1=n$3(x);
...
const transportAllA11yAttributes = ({
  host,
  target,
  removeOriginal = true,
}) => {
...
class AuroButton extends AuroElement {
   ...
   */
  get _renderTag() {
    if (this.static) return i$5`span`;

    return this.buttonHref ? i$5`a` : i$5`button`;
  }
  ...
  renderLayoutDefault() {
    ...
    return u$1`
      ...
      >
        ${o(this.loading ? u$1`<${this.loaderTag} pulse part="loader"></${this.loaderTag}>` : undefined)}

        <span class="${e(contentClasses)}" part="contentWrapper">
          <span class="${e(textSlotClasses)}" part="text">
            <slot></slot>
          </span>
        </span>
      </${this._renderTag}>
